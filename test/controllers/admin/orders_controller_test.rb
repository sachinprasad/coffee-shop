...
class Admin::OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_order" do
    assert_difference('Admin::Order.count') do
      post admin_orders_url, params: { admin_order: { final_total: @admin_order.final_total, order_status: @admin_order.order_status } }
    end
  ...
  test "should update admin_order" do
    patch admin_order_url(@admin_order), params: { admin_order: { final_total: @admin_order.final_total, order_status: @admin_order.order_status } }
